package cl.ProyectoEcommerce.ms_ordenes.security;
...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        // Todo el módulo de órdenes requiere un usuario autenticado con Azure AD
    ...
    public JwtDecoder jwtDecoder() {
        ...
        OAuth2TokenValidator<Jwt> audienceValidator = jwt -> {
            ...
            return OAuth2TokenValidatorResult.failure(
                    new OAuth2Error("invalid_audience", "La audiencia del token no coincide con este microservicio.",
                            null));
        };

        jwtDecoder.setJwtValidator(
                new DelegatingOAuth2TokenValidator<>(withTimestamp, issuerValidator, audienceValidator));
